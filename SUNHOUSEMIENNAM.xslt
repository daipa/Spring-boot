    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <style type="text/css" rel="stylesheet">
          ...
          border-right: 1px solid rgb(7, 74, 142) ;
          border-left: 1px solid rgb(7, 74, 142) ;
          ...
          {
          border-bottom: 1px dotted rgb(7, 74, 142) ;
          border-right: 1px solid rgb(7, 74, 142) ;
          border-left: 1px solid rgb(7, 74, 142) ;
          border-top: 0 none;
          }
          ...
          {
          font-size: 100%;
          border-bottom: 1px dotted rgb(7, 74, 142) !important;
          }
            ...
            <xsl:for-each select="Invoice//Content/Products/Product[(position()-1) mod 10 = 0]">
              ...
              <div class = "VATTEMP">
                <div  class ="pagecurrent" id="page_{position()}">
                  <div style="width:816!important">
                    <div class="statistics"  style="float:left;">
                      <div style="font-size:12px;border-bottom:1px dashed rgb(7, 74, 142); width:826px; text-align: center; color: rgb(7, 74, 142);margin-bottom: 2px;">
                      ...
                      <div class="nenhd" style="margin-bottom: 10px!important;">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="width:816!important;">
                          <thead>
                            ...
                            <xsl:for-each select="/Invoice//Content">
                              <tr style=";background-color: white!important;">
                                <td colspan="6" style="padding-left: 0px!important;padding-right: 0px!important;">
                                  <table cellspacing="0" cellpadding="0"  style="width:816px!important;border-bottom: 1px solid rgb(7, 74, 142)">
                                    <tr>
                                      ...
                                      <td colspan="2" style=" border-left: none!important;border-right: none!important;border-bottom: none!important;">
                                        <div style="margin-top: 10px; float: left; text-align: center;">
                                          <div>
                                            <div>
                                              <p class="name-upcase" style="font-weight: bold;color:red;line-height: 26px; margin-top: 10px; margin-bottom: 0px;font-size:23px; text-transform: uppercase;">
                                            ...
                                            <xsl:choose>
                                              <xsl:when test="substring(ArisingDate,7,4)!= '1957' and substring(ArisingDate,7,4)!= ''">
                                                Ngày&#160;
                                                <label style="border-bottom: 1px dotted #000000; color:#000000">
                                                  <b>
                                      ...
                                      <td colspan="2" style=" border-left: none!important;border-right: none!important;border-bottom: none!important;">
                                        <div class="header-note" style="width: 205px;text-align:left;color: #000000;line-height: 20px!important;">
                                          <p style="color: rgb(7, 74, 142) !important;">
                                  ...
                                  <table cellspacing="0" cellpadding="0"  style="width:670px!important; float: left;    margin-top: 10px;">
                                    <tr>
                                      <td colspan="1" style="width: 155px; border-left: none!important;border-top:none!important; border-right: none !important;">

                                        <div class="fl-l2">
                                          <label class="fl-l" style="width:155px">
                                            Đơn vị bán hàng <i>(Issued)</i>:
                                          </label>
                                    ...
                                    <tr>
                                      <td colspan="1" style=" width: 155px;border-left: none!important;    border-right: none !important;">
                                        <div class="fl-l2">
                                          <label class="fl-l" style="width:155px">
                  ...
                  <label class="input-code" maxlength="1" style="margin-right:0px; height:14px">
                    <xsl:value-of select="substring(ComTaxCode,14,1)"/>
                                    ...
                                    <tr>
                                      <td colspan="1" style=" width: 155px;border-left: none!important;    border-right: none !important;">
                                        <div class="fl-l2" style="clear: both;">
                                          <div class="fl-l" style="clear: both;">
                                            <label class="fl-l" style="width:155px">
                                              Địa chỉ <i>(Address)</i>:
                                            </label>
                                          </div>
                                    ...
                                    <tr>
                                      <td colspan="1" style=" width: 155px;border-left: none!important; border-bottom: none!important;     border-right: none !important;">
                                        <div class="fl-l2" style="clear: both;">
                                          <label class="fl-l" style="width: 155px">
                                    ...
                                    <td colspan="1" style=" border-left: none!important; border-bottom: none!important;     border-right: none !important;">
                                        <div class="fl-l2" style="clear: both;">
                                          <label class="fl-l" >
                                            <xsl:choose>
                                  ...
                                  <table cellspacing="0" cellpadding="0"  style="width:824px!important;float: left;">
                                    <tr>
                                      <td colspan="6" style=" border-left: none!important;border-right: none!important;border-top: 1px solid rgb(7, 74, 142) !important;">
                                        <div class="clearfix">
                        ...
                         
                                        ...
                                        <div class="clearfix">
                                          ...
                                          <xsl:choose>
                                            <xsl:when test="Kind_of_Payment!=''">
                                              <label class="fl-l input-name" style="width:260px;">
                                          ...
                                          <label class="fl-l2" style="width:127px">
                                            Số tài khoản<i>(AC No)</i> :
                                          </label>
                                          <label class="fl-l input-name" style="width:126px;">
                                            <xsl:choose>
                          ...
                          <tbody class="nenhd">
                            <tr style="color: rgb(7, 74, 142) !important;">
                              <th >
                                STT<br/>
                                <i>(No.)</i>
                              </th>
                            ...
                            <xsl:for-each select="..//../Products/Product[  ($level1Count  + 10)  >= position() and  position() >  $level1Count]">
                              <tr class="noline back">
                                ...
                                <td class="back-bold2">
                                  <div style="display: block;word-wrap: break-word;width: 300px;text-align: left;  overflow: hidden;">
                                    <xsl:value-of select="ProdName"/>
                                  </div>
                                </td>
                                <td class="back-bold2">
                                  <div style="display: block;word-wrap: break-word;width: 100px;text-align: left;  overflow: hidden;">
                                    <xsl:value-of select="ProdUnit"/>
                                  </div>
                                </td>
                                <td class="back-bold">
                                  <div style="display: block;word-wrap: break-word;width: 100px;text-align: center;  overflow: hidden;">
                                    <xsl:choose>
                                ...
                                <td class="back-bold">
                                  <div style="display: block;word-wrap: break-word;width: 100px;text-align: right;  overflow: hidden;">
                                    <xsl:choose>
                              ...
                              <xsl:if test="(position() + $level1Count)= $itemCount">
                                ...
                                <tr  class="noline back" style="border-top: 1px solid rgb(7, 74, 142);">
                                  <td class="back-bold" colspan="5" style="    border-bottom: none !important;padding-left: 0px;text-align: right!important;border-left: none !important;border-right: none !important;">
                                    <label style="color: rgb(7, 74, 142) !important;">
                                      Cộng tiền hàng <i>(Total amount)</i>:
                                    </label>
                                  </td>
                                  <td style="    border-bottom: none !important;text-align: right;border-left: none !important;border-right: none !important;">
                                    <label class="fl-l input-name" style="float: right;width:100px;">
                                      <xsl:choose>
                                ...
                                <tr class="noline back" style="border-left: none !important;border-right: none !important;">
                                  <td class="back-bold" colspan="2" style="border-left: none !important;border-right: none !important;border-bottom: none !important">
                                    <div class="clearfix">
                                      <label class="fl-l2" style="float:left">
                                        Thuế suất thuế GTGT<i>(VAT rate)</i> :
                                      </label>
                                      <label class="fl-l input-name">
                                        <xsl:choose>
                                  ...
                                  <td colspan="3" style="text-align: right;border-left: none;border-left: none !important;border-right: none !important;border-bottom: none !important">
                                    <label style="color: rgb(7, 74, 142) !important;">
                                      Tiền thuế GTGT <i>(VAT amount):</i>
                                    </label>
                                  </td>
                                  <td style="text-align: right;border-left: none !important;border-right: none !important;border-bottom: none !important">
                                    <label class="fl-l input-name" style="float: right!important;width: 100px;">
                                      <xsl:choose>
                                ...
                                <tr class="noline back" style="border-top: none !important; ">
                                  <td class="back-bold" style="text-align: right;border-left: none !important;border-right: none !important;border-bottom: none !important;border-top: none !important" colspan="5">
                                    <label style="color: rgb(7, 74, 142) !important;">
                                      Tổng Cộng tiền thanh toán<i>(Total payment)</i> :
                                    </label>
                                  </td>
                                  <td style="border-left: none !important;border-right: none !important;border-bottom: none !important;important;border-top: none !important">
                                    <label class="fl-l input-name" style="float: right;width: 100px;text-align: right;">
                                      <xsl:choose>
                                ...
                                <tr class="noline back" style="border-top: 1px solid rgb(7, 74, 142); border-bottom: none !important;border-left: none !important;border-right: none !important;">
                                  <td colspan="6" style="padding-right: 0px;border-left: none !important;border-right: none !important;    border-bottom: none !important;">
                                    <div class="clearfix">
                                      <label class="fl-l2">
                                        Số tiền viết bằng chữ <i>(Amount In words)</i>:
                                      </label>
                                      <label class="fl-l input-name" style="padding-left: 10px; text-align: left; width:568px">
                                        <xsl:choose>
                                ...
                                <tr  class="noline back" style="border-bottom: none!important;border-top: none !important">
                                  <td colspan="6" style="border: none!important" >
                                    <table>
                                      <tr>
                                        <td colspan="2" style="text-align:center; margin-top:0px; border: none!important">
                                          <b style="margin-right:0px; color: rgb(7, 74, 142) !important;">Người mua hàng (Buyer)</b>
                                        </td>
                                        <td colspan="2" style="text-align:center; margin-top:0px; border: none!important; ">

                                        </td>
                                        <td colspan="2" style="text-align:center; margin-top:0px; border: none!important">
                                          <b style="margin-left:0px; color: rgb(7, 74, 142) !important;">Người bán hàng (Seller)</b>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td colspan="2" style="text-align:center; border: none!important">
                                          <i style="margin-left:0px; color: rgb(7, 74, 142) !important;"> (Ký, ghi rõ họ tên)</i>
                                        </td>
                                        <td colspan="2" style="text-align:center;border: none!important;">
                                      ...
                                      <tr>
                                        <td colspan="2" style="text-align:center; border: none!important">
                                          <i style="margin-left:0px; color: rgb(7, 74, 142) !important;"> (Sign,full name)</i>
                                        </td>
                                      ...
                                      <tr>
                                        <td colspan="2" style=" border: none!important">
                                          <div class="payment fl-l" style="width:100%;float:left;">&#160; </div>
                                        </td>
                                        <td colspan="2" style="  border: none!important;">

                                        </td>
                                        <td colspan="2" style="  border: none!important">
                                          <div class="payment fl-l" style="width:100%;float:right;">
                                            <p style="font-size:12px; margin:0px;color:red!important;" class="ComNameSignDate">
                                              ...
                                              <xsl:choose>
                                                <xsl:when test="/Invoice/image != '' ">
                                                  <div class="bgimg" style="display: block; margin: 0 auto;width:185px;background:url({/Invoice/image/@URI}) no-repeat center center" onclick="showDialog('dialogServer','{$serial}','{$pattern}','{$invno}',0,'messSer','is')">
